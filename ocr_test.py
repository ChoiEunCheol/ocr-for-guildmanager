...
# 이미지 파일 불러오기 및 크롭하기
image = Image.open('./sharp_image1.jpg')
...
# 이미지에서 텍스트 추출
text = pytesseract.image_to_string(cropped_image_cv, lang='eng', config='--psm 6 --oem 3 outputbase digits --dpi 96 --user-patterns my_custom_patterns.txt')
